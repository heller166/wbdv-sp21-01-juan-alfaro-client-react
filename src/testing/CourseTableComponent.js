        ...
        <>
            <div className="sticky-top">
                <div className="row" style={{paddingTop: "10px"}}>
                    ...
                    <div className="col-1">
                        <i style={{color: "red"}}
                           className="float-right fas fa-plus-circle fa-2x"/>
                    </div>
                </div>
            </div>
            <div style={{marginTop: "0px", padding: "15px"}}>
                <div className="row" style={{
                    ...
                    <div className="col-4 col-md-3 col-lg-2">
                        <i className="fas fa-th float-right" style={{marginLeft: "20px"}}/>
                        <i className="fas fa-sort-alpha-up-alt float-right" style={{marginLeft: "20px"}}/>
                        <i className="fas fa-folder float-right" style={{marginLeft: "20px"}}/>
                    </div>
                </div>
                <div>
                    {
                        courses.map(course =>
                                <div className="row"
                                     style={{fontSize: "1.7em", borderBottom: "1px solid #cccccc", padding: "5px"}}>
                                    <div className="col-8 col-md-7 col-lg-6">
                                        {
                                            course.editing &&
                                            <input value={course.title} className="form-control"
                                                   style={{fontSize: "0.9em", padding: "0px", paddingLeft: "15px"}}/>
                                        }
                                        {
                                            !course.editing &&
                                            <span className="">
                    <i className="fas fa-file" style={{marginRight: "10px", color: "blue"}}/>
                    <span>{course.title}</span>
                      ...
                      <i style={{color: "green", marginLeft: "5px"}} className="fas fa-check"/>
                      <i style={{color: "red", marginLeft: "5px"}} className="fas fa-times"/>
                  </span>
                                        }
                                        {
                                            !course.editing &&
            ...
            <div className="row" style={{fontSize: "1.5em", fontWeight: "bold", marginTop: "10px"}}>
                ...
                <div className="col-12 col-md-3">
                    <i className="fas fa-list float-right" style={{marginLeft: "20px"}}/>
                    <i className="fas fa-sort-alpha-up-alt float-right" style={{marginLeft: "20px"}}/>
                    <i className="fas fa-folder float-right" style={{marginLeft: "20px"}}/>
                </div>
            </div>
            <div className="row">
                {
                    courses.map(course =>
                      ...
                      <i style={{color: "green", marginLeft: "5px"}} className="fas fa-check fa-2x"/>
                      <i style={{color: "red", marginLeft: "5px"}} className="fas fa-times fa-2x"/>
                  </span>
                                    }
                                    <img src={course.image}
                                         className="card-img-top" alt="Card Text"/>
                          ...
                          {course.title}
                                        ...
                                        <a href="#" className="btn btn-primary">{course.title}</a>
                                        {
                                            ...
                                            <i style={{color: "blue", position: "absolute", bottom: "10px", right: "5px"}}
                                               className="fas fa-edit float-right fa-2x"/>
                                        }
                                    </div>
                                </div>
                            </div>
            ...
            <i className="fas fa-plus-circle fa-5x"
               style={{backgroundColor: "white", color: "red", position: "fixed", right: "10px", bottom: "10px"}}/>
        </>
    )
}
